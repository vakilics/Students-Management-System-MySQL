...
# We can use sqlite3 as backend database or MySQL
"""mysql> CREATE database school;
mysql> USE school;
Database changed
mysql> CREATE TABLE students( id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), course VARCHAR(255), mobile VARCHAR(255) );
mysql> INSERT INTO students (name,course,mobile) VALUES("Hamid Vakili", "Math", "12345");
"""
